...
mkdir -p "$TARGET_DIR"/{user-interviews/{snapshots,synthesis,transcripts},opportunities,assumptions,solutions,design,product-analytics,prd,tasks}
...
for folder in assumptions design opportunities prd product-analytics solutions tasks user-interviews; do
...
echo ""
echo "Next steps:"
echo "  1. Start user research: create interview snapshots in user-interviews/snapshots/"
echo "  2. Synthesize findings: create synthesis in user-interviews/synthesis/"
echo "  3. Identify opportunities: create opportunities in opportunities/"
echo "  4. Create a PRD: save to prd/"
echo "  5. Generate tasks: save to tasks/"
