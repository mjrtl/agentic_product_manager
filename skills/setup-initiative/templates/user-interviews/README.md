...
**Usage:** Use the continuous-discovery skill's "create interview snapshots" workflow to generate structured interview snapshots.
...
---
*Use the continuous-discovery skill for structured interview analysis.*
