...
Use the product-documents skill's "create design brief" workflow to generate:
...
Use the product-documents skill's "generate Figma Make prompt" workflow to create:
...
- **Design System**: References existing components and design tokens
