...
This reference provides team structure design models and principles. AI agents and workflows become more powerful when they understand **organizational context**, so providing team structure materials enables **automated reviews, decision support, and strategic feedback**.
...
* **Examples**: Starbucks (department-based), Apple (function separation)
* **Key Stakeholders**: Functional leaders
* **Core Metrics**: Functional efficiency, cost reduction
...
* **Examples**: Philips Consumer Health, Google
...
* **Examples**: Spotify (Squad/Chapter/Guild), HubSpot (product line-based)
...
* **Examples**: General Electric, Amazon
* **Key Stakeholders**: Division leaders (GM, VP)
* **Core Metrics**: Division-level financial performance (P&L, ROI)
...
* **Value Stream Teams**: Teams organized by customer journey or business flow
* **Divisional**: Separated by business units
...
3. **Balance of Speed and Consistency**
   ...
   * Centralized (Functional) when user experience consistency is important.

4. **Importance of People and Culture**
   * Good leaders, team skills, and culture are more important than structure.

## How to Use This Reference

1. Upload organizational structure documents (org-chart, org-structure.md) to your workspace
2. When running strategy reviews, reference team structure documents for team responsibility and role-based feedback
...
**Tip:** Including not just "current structure" but also **why this structure was chosen (strategic context)** in organizational documents enables more sophisticated feedback.
