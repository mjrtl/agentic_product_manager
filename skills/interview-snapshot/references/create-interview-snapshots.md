# Create Interview Snapshots - Reference

## Goal

Systematically extract meaningful insights from qualitative interviews or user test sessions, creating structured interview snapshots that capture specific stories, opportunities, and behavioral insights following the Continuous Discovery Habits methodology.

## Output

**Format:** Markdown (`.md`)
**Location (preferred):** `1-discovery/1.2-user-interviews/snapshots/`  
**Location (legacy):** `discovery/user-interviews/snapshots/`
...
## Experience Map
*A text-based, visual representation of the participant's journey for a specific story.*
...
## Opportunities
- **[Opportunity title]**: [Specific description of customer needs, pain points, desires; chances to intervene in a way that improves customers' lives.]

---

## Insights
- **[Insight category]**: [Pattern or behavior that goes beyond a single story]
```
...
- Map the complete journey, not the happy path only
