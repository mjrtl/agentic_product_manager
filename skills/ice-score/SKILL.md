...
name: ICE Score
description: >
  Score ideas on Impact, Confidence, and Ease using evidence-guided methodology.
  Computes ICE Score = Impact x Confidence x Ease with priority bucket assignment.
