...
for init_dir in "$INITIATIVES_DIR"/*/; do
  ...
  prfaqs=$(find "$init_dir/prd" -name "pr-faq-*.md" 2>/dev/null | wc -l | tr -d ' ')
  prds=$(find "$init_dir/prd" -name "*.md" -not -name "README.md" -not -name "pr-faq-*.md" 2>/dev/null | wc -l | tr -d ' ')
  tasks=$(find "$init_dir/tasks" -name "*.md" -not -name "README.md" 2>/dev/null | wc -l | tr -d ' ')
  qa=$(find "$init_dir/qa" -name "*.md" -not -name "README.md" 2>/dev/null | wc -l | tr -d ' ')
  dora=$(find "$init_dir/delivery-metrics" -name "*.md" -not -name "README.md" 2>/dev/null | wc -l | tr -d ' ')
  launch=$(find "$init_dir/launch" -name "*.md" -not -name "README.md" 2>/dev/null | wc -l | tr -d ' ')
